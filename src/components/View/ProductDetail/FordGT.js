        ...
        <div className="w-full mt-20">
            <div className="flex h-120" >
                ...
                <div className="w-1/2 ml-16">
                    ...
                    <div className=" ml-4 mb-4 mr-10 text-justify">Ford GT 2006, producing 2020, running 12,000miles, and genuine warranty, "Special high -capacity" car with different optiosn, running much more sensitive than normal version. Good will to negotiate for buyers</div>
            ...
            <div className="flex">
                <div className="w-1/2">
                    ...
                    <div className="ml-14 mr-14 mt-4">
                        <p className="text-justify">The Ford story begins in the 1960s, a booming time for the American car industry.
